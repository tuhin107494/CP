...
void input()
{
    ...
    while(m--)
    {
        ...
        cin>>x;
        ll pre_id=bs(1,x-1,a[x]);//(1.....x-1 indx er modde x theke sob cheyere kun indx a[x] theke chuto
        ll suf_id=bs(x+1,n,a[x]);//(x+1 ..........n indx er modde sobh theke kache kun indx a[i] theke chuto
